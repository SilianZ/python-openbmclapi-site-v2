...
在本文档中，python-openbmclapi 也指 Python OpenBMCLAPI。
...
在贡献之前，请先阅读我们的[贡献准则](https://github.com/TTB-Network/python-openbmclapi/blob/master/CONTRIBUTING.md)。
