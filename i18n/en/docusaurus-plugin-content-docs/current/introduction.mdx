...
🎉 <strong><i>New features!</strong></i> WebDAV support. Through WebDAV (Web-based Distorting and Versioning), users can edit and manage files stored on web servers in collaboration with them. 
